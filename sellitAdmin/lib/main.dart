import 'package:app_drawer/app.dart';
import 'package:app_drawer/app_product.dart';
import 'package:app_drawer/app_user.dart';
...
void main(){
  ...
  var app = MaterialApp(
    ...
    home: Login(),
    routes:{
      "/user": (BuildContext context) => AppUser(),
      "/product": (BuildContext context) => AppProduct(),
