                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        //product price
                                        Text(
                                          "\VND ${cartCtlr.cart[index].product.price}",
                                        ),
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text:
                                  '\VND ${context.watch<CartController>().cart.fold(0, (previousValue, element) => previousValue + (element.product.price * element.quantity))}',
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                              ),
                            ),
